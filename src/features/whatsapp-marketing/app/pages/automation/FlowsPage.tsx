...
import { Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle, DialogTrigger, DialogFooter } from "@whatsapp/components/ui/dialog";
...
export default function FlowsPage() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      navigate(`/automation/flows/${data._id}/edit`);
    },
