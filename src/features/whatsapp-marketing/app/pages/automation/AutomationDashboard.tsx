    ...
    <>
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="hover:shadow-md transition-shadow cursor-pointer" onClick={() => navigate("/automation/triggers")}>
          ...
          <Card className="hover:shadow-md transition-shadow cursor-pointer" onClick={() => navigate("/automation/flows")}>
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
          ...
          <Card className="hover:shadow-md transition-shadow cursor-pointer" onClick={() => navigate("/automation/campaigns")}>
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
